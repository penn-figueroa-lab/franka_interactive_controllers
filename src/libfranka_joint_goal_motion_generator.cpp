  ...
  try {
    ...
    switch(goal_id) {
       case 1  :
          ...
          // wipe q_goal = {{0.036008717721881786, 0.7633170133317922, 0.3862981354430629, -1.7993838191995106, -1.3797023201961882, 1.1948259612442647, 1.014551854229974}};         
          q_goal = {{0.2890, 0.3608, -0.0844, -2.2857, -1.2469, 2.2430, 0.4}};
          break;
       case 2  :
        std::cout << "Bi manual moving task" << std::endl;
          ...
          q_goal = {{-0.059555029700205285, -0.5426480485709787, 0.1444915925054697, -2.859532581154814, -0.9401807467636566, 1.9243664236995661, -0.18153685991134907}};
          break;
       case 3  :
          std::cout << "Selected q_pick_1 as goal" << std::endl;
          q_goal = {{0.0, -0.7854, 0.0, -2.356, 0.0, 1.57, 0.0}};
          break;
       ...
       case 5  :
        std::cout << "Selected q_release as goal" << std::endl;
          q_goal = {{0.48328086364371037, 0.2003571095748714, 0.7123594751441125, -2.240429000746111, -0.19041608722700434, 2.3838315841932163, 1.324765390708516}};
          break;

       case 6  :
        std::cout << "Selected q_release as goal" << std::endl;
          q_goal = {{0, 0.48598658122263144, 0, -1.2121057474316534, 0, 1.6981089110050012, 0}};
          break;
       // case 4  :
